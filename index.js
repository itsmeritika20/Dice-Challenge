...
var randomImageSource = "images/" + randomDiceImage; //images to dice1.png to dice6.png
var image1 = document.querySelectorAll("img")[0];
image1.setAttribute("src", randomImageSource);

var randomNumber2 = Math.floor(Math.random() * 6) + 1; //1 to 6
var randomImageSource2 = "images/dice" + randomNumber2 + ".png"; //images to dice1.png to dice6.png
